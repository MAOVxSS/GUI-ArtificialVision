...
from Utils.paths import phrases_model_json_data_path, phrases_model_converted_data_path, phrases_model_rnn_keras_path

from Utils.config import phrases_model_rnn_keras_name
from Model.model_utils import plot_history

def train_and_save_model(model_path, epochs=100, max_length_frames=15, max_length_keypoints=1662):
    ...
    # Definir la arquitectura del modelo sustituyendo LSTM por SimpleRNN
    from keras.optimizers import Adam

    model = Sequential()

    # Primera capa SimpleRNN con BatchNormalization
    model.add(
        SimpleRNN(
            128,
    ...
    # Guardar el scaler
    import joblib
    scaler_save_path = os.path.join(phrases_model_rnn_keras_path, 'scaler.save')
...
if __name__ == "__main__":
    ...
    train_and_save_model(os.path.join(phrases_model_rnn_keras_path, phrases_model_rnn_keras_name))
