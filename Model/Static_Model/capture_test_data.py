...
# Rutas y variables
from Utils.paths import static_model_data_labels_path, static_model_test_data_path
...
def main():
    ...
    while cap.isOpened():
        ...
        if capturing:
            save_data(keypoints, label_id, static_model_test_data_path)  # Guardar los datos capturados
            ...
            count_samples_for_label(static_model_test_data_path, label_id)  # Muestra el conteo de múestras
