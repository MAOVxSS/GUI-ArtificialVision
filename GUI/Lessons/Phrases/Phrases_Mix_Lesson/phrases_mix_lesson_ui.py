...
def create_mix_lesson_phrases_window(window):
    ...
    from GUI.Lessons.Phrases.Phrases_Mix_Lesson.phrases_mix_lesson_logic import (load_phrase_data, PHRASES,
    start_phrases_mix_recognition_cycle)
    ...
    start_phrases_mix_recognition_cycle(window, video_label, progress_label, current_phrase_index)
