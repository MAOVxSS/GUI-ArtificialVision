...
from Utils.paths import assets_json_phrases_info_path, assets_json_info_signs_path
import json
...
def show_tip_phrases_window(actual_phrase):
    ...
    if actual_phrase in data:
        letter_data = data[actual_phrase]

        # Crear la ventana emergente
        tip_window = Toplevel()
        tip_window.title(f"Tip para la letra {actual_phrase}")
