...
def create_camera_letters_window(window, actual_letter, letter_type):
    # Importar funciones para iniciar y detener el reconocimiento de señas
    from GUI.Camera.Camera_Letters.camera_letters_model_logic import (start_static_sign_recognition,
                                                                      stop_video_stream)
    ...
    if letter_type == 'Estatico':
        ...
        evaluate_phrases_model(video_label, window, actual_letter)
