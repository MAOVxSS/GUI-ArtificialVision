...
def relative_to_assets_dictionary_alphabet(path: str) -> Path:
...
def create_dictionary_alphabet_window(window):
    ...
    button_image_b = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_b.png"))
    ...
    button_image_c = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_c.png"))
    ...
    button_image_d = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_d.png"))
    ...
    button_image_e = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_e.png"))
    ...
    button_image_f = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_f.png"))
    ...
    button_image_g = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_g.png"))
    ...
    button_image_h = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_h.png"))
    ...
    button_image_i = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_i.png"))
    ...
    button_image_j = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_j.png"))
    ...
    button_image_k = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_k.png"))
    ...
    button_image_l = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_l.png"))
    ...
    button_image_m = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_m.png"))
    ...
    button_image_n = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_n.png"))
    ...
    button_image_nn = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_nn.png"))
    ...
    button_image_o = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_o.png"))
    ...
    button_image_p = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_p.png"))
    ...
    button_image_q = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_q.png"))
    ...
    button_image_r = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_r.png"))
    ...
    button_image_s = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_s.png"))
    ...
    button_image_t = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_t.png"))
    ...
    button_image_u = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_u.png"))
    ...
    button_image_v = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_v.png"))
    ...
    button_image_z = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_z.png"))
    ...
    button_image_y = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_y.png"))
    ...
    button_image_x = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_x.png"))
    ...
    button_image_w = PhotoImage(file=relative_to_assets_dictionary_alphabet("letter_w.png"))
    ...
    button_image_go_back = PhotoImage(file=relative_to_assets_dictionary_alphabet("regresar.png"))
    ...
    button_image_go_home = PhotoImage(file=relative_to_assets_dictionary_alphabet("inicio.png"))
    ...
    # Configurar la lógica para cada botón de letra para abrir la ventana de información de la letra seleccionada
